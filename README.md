# Diversification during chronic <em>Helicobacter pylori</em> infection within a single individual results in sub-populations with distinct phenotypic properties
